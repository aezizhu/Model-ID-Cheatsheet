...
var Models = map[string]Model{
	...
	"glm-4.7-flashx": {
		...
		ReleaseDate:     "2025-12",
		Status:          "current",
		Notes:           "Fast cost-efficient variant of GLM-4.7, reasoning support. API: open.bigmodel.cn",
	},
	"glm-4.6v": {
		ID:              "glm-4.6v",
	...
	"nvidia/nemotron-3-nano-30b-a3b": {
		...
		ReleaseDate:     "2025-12",
		Status:          "current",
		Notes:           "Hybrid MoE 30B total, 3.5B active, 1M context. Free on build.nvidia.com, pricing varies by host",
	},
	"nvidia/llama-3.1-nemotron-ultra-253b-v1": {
		...
		ReleaseDate:     "2025-04",
		Status:          "current",
		Notes:           "Flagship 253B via NAS from Llama 3.1 405B, fits on single 8xH100 node. Free on build.nvidia.com, pricing varies by host",
	},
	...
	"phi-4": {
		...
		ReleaseDate:     "2024-12",
		Status:          "current",
		Notes:           "14B SLM, strong reasoning. Azure: Phi-4, OpenRouter: microsoft/phi-4",
	},
	"phi-4-multimodal-instruct": {
		...
		ReleaseDate:     "2025-02",
		Status:          "current",
		Notes:           "5.6B multimodal (vision+audio), 128K context. Azure: Phi-4-multimodal-instruct",
	},
	...
	"minimax-m2.1": {
		...
		ReleaseDate:     "2025-12",
		Status:          "current",
		Notes:           "Latest MiniMax, MoE (230B/10B active), interleaved thinking, optimized for coding and agents",
	},
	"minimax-01": {
		ID:              "minimax-01",
