...
MCP server exposing a curated, static registry of 94 AI models across 19 providers. Built in Go with the official MCP SDK.
...
| `go-server/internal/models/data.go` | `Models` map with all 94 model entries |
...
| `go-server/cmd/updater/main.go` | Auto-update engine (scrapes public docs, creates PRs for deprecations, issues for new models) |
...
| `.github/workflows/auto-update.yml` | Optional: GitHub Actions alternative to Railway cron |
