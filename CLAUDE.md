...
MCP server exposing a curated, static registry of 76 AI models across 11 providers. Built in Go with the official MCP SDK.
...
| `go-server/internal/models/data.go` | `Models` map with all 76 model entries |
